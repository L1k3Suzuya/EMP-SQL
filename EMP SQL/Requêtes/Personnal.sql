...
SELECT * FROM dept
-------------------------------------------------------------
3. Afficher le nom, la date embauche, le numéro du supérieur, le
numéro de département et le salaire de tous les employés.
-------------------------------------------------------------
SELECT nom, dateemb, nosup, nodep, salaire AS employe 
FROM employe;
-------------------------------------------------------------
4. Afficher le titre de tous les employés.
SELECT nom, titre AS employe
FROM employe;
-------------------------------------------------------------
5. Afficher les différentes valeurs des titres des employés.
SELECT DISTINCT titre AS employe
FROM employe;
-------------------------------------------------------------
6. Afficher le nom, le numéro employé et le numéro du
département des employés dont le titre est « Secrétaire ».

SELECT Nom, noemp, nodep, titre AS employe
FROM employe
...
SELECT Nom, salaire, nodep, titre AS employe
FROM employe
...
SELECT Nom, titre, salaire AS employe
FROM employe
...
SELECT Nom, titre, nodep, salaire AS employe
FROM employe
WHERE nodep = 34
...
employés dont le taux de commission est pas renseigné.
...
employés dont le taux de commission est pas nul. (la commission
...
employés dont le taux de commission est pas nul, classé par taux de
...
SELECT CONCAT(nom, '', prenom) AS nom_et_prénom 
FROM employe
...
SELECT nom, LOCATE ('r', nom) AS position 
FROM employe

-------------------------------------------------------------
31. Afficher le nom, le nom en majuscule et le nom en minuscule de
employé dont le nom est Vrante.
